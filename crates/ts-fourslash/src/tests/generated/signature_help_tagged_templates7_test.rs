...
#[test]
pub fn test_signature_help_tagged_templates7() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates7(&mut t);
}

fn run_test_signature_help_tagged_templates7(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpTaggedTemplates7") {
        return;
    }
