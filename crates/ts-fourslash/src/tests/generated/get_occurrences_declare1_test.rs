...
#[test]
pub fn test_get_occurrences_declare1() {
    let mut t = TestingT;
    run_test_get_occurrences_declare1(&mut t);
}

fn run_test_get_occurrences_declare1(t: &mut TestingT) {
    if should_skip_if_failing("TestGetOccurrencesDeclare1") {
        return;
    }
