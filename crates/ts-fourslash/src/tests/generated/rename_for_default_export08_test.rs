...
#[test]
pub fn test_rename_for_default_export08() {
    let mut t = TestingT;
    run_test_rename_for_default_export08(&mut t);
}

fn run_test_rename_for_default_export08(t: &mut TestingT) {
    if should_skip_if_failing("TestRenameForDefaultExport08") {
        return;
    }
