...
#[test]
pub fn test_code_fix_missing_type_annotation_on_exports58_genercs_doesnt_drop_trailing_unknown_2() {
    let mut t = TestingT;
    run_test_code_fix_missing_type_annotation_on_exports58_genercs_doesnt_drop_trailing_unknown_2(
        &mut t,
    );
}
