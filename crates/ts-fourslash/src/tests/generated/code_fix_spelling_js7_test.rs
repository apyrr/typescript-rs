...
#[test]
pub fn test_code_fix_spelling_js7() {
    let mut t = TestingT;
    run_test_code_fix_spelling_js7(&mut t);
}

fn run_test_code_fix_spelling_js7(t: &mut TestingT) {
    if should_skip_if_failing("TestCodeFixSpellingJs7") {
        return;
    }
