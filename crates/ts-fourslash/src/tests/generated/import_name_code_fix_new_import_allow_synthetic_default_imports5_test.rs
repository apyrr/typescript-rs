...
#[test]
pub fn test_import_name_code_fix_new_import_allow_synthetic_default_imports5() {
    let mut t = TestingT;
    run_test_import_name_code_fix_new_import_allow_synthetic_default_imports5(&mut t);
}
