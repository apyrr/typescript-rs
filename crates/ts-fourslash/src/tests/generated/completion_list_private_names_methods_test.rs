...
#[test]
pub fn test_completion_list_private_names_methods() {
    let mut t = TestingT;
    run_test_completion_list_private_names_methods(&mut t);
}

fn run_test_completion_list_private_names_methods(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionListPrivateNamesMethods") {
        return;
    }
