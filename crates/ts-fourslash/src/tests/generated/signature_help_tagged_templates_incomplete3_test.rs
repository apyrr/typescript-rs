...
#[test]
pub fn test_signature_help_tagged_templates_incomplete3() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates_incomplete3(&mut t);
}

fn run_test_signature_help_tagged_templates_incomplete3(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpTaggedTemplatesIncomplete3") {
        return;
    }
