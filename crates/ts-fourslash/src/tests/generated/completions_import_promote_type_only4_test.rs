...
#[test]
pub fn test_completions_import_promote_type_only4() {
    let mut t = TestingT;
    run_test_completions_import_promote_type_only4(&mut t);
}

fn run_test_completions_import_promote_type_only4(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionsImport_promoteTypeOnly4") {
        return;
    }
