...
#[test]
pub fn test_go_to_source3_node_modules_at_types() {
    let mut t = TestingT;
    run_test_go_to_source3_node_modules_at_types(&mut t);
}

fn run_test_go_to_source3_node_modules_at_types(t: &mut TestingT) {
    if should_skip_if_failing("TestGoToSource3_nodeModulesAtTypes") {
        return;
    }
