...
#[test]
pub fn test_signature_help_on_overloads_different_arity2() {
    let mut t = TestingT;
    run_test_signature_help_on_overloads_different_arity2(&mut t);
}

fn run_test_signature_help_on_overloads_different_arity2(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpOnOverloadsDifferentArity2") {
        return;
    }
