...
#[test]
pub fn test_organize_imports_paths_unicode1() {
    let mut t = TestingT;
    run_test_organize_imports_paths_unicode1(&mut t);
}

fn run_test_organize_imports_paths_unicode1(t: &mut TestingT) {
    if should_skip_if_failing("TestOrganizeImportsPathsUnicode1") {
        return;
    }
