...
#[test]
pub fn test_signature_help_tagged_templates2() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates2(&mut t);
}

fn run_test_signature_help_tagged_templates2(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpTaggedTemplates2") {
        return;
    }
