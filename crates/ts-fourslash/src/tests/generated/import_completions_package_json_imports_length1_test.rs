...
#[test]
pub fn test_import_completions_package_json_imports_length1() {
    let mut t = TestingT;
    run_test_import_completions_package_json_imports_length1(&mut t);
}

fn run_test_import_completions_package_json_imports_length1(t: &mut TestingT) {
    if should_skip_if_failing("TestImportCompletionsPackageJsonImportsLength1") {
        return;
    }
