...
#[test]
pub fn test_get_occurrences_declare3() {
    let mut t = TestingT;
    run_test_get_occurrences_declare3(&mut t);
}

fn run_test_get_occurrences_declare3(t: &mut TestingT) {
    if should_skip_if_failing("TestGetOccurrencesDeclare3") {
        return;
    }
    let content = r"
[|declare|] var x;
