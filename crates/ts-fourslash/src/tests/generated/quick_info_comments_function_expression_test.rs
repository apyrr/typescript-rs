...
#[test]
pub fn test_quick_info_comments_function_expression() {
    let mut t = TestingT;
    run_test_quick_info_comments_function_expression(&mut t);
}

fn run_test_quick_info_comments_function_expression(t: &mut TestingT) {
    if should_skip_if_failing("TestQuickInfoCommentsFunctionExpression") {
        return;
    }
