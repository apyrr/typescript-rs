...
#[test]
pub fn test_tsx_find_all_references9() {
    let mut t = TestingT;
    run_test_tsx_find_all_references9(&mut t);
}

fn run_test_tsx_find_all_references9(t: &mut TestingT) {
    if should_skip_if_failing("TestTsxFindAllReferences9") {
        return;
    }
