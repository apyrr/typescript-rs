...
#[test]
pub fn test_code_fix_class_implement_interface_auto_imports() {
    let mut t = TestingT;
    run_test_code_fix_class_implement_interface_auto_imports(&mut t);
}
...
export class C implements Base {[| |]}"#;
    ...
    f.verify_code_fix(
        ...
        VerifyCodeFixOptions {
            ...
            new_file_content: r"import { Base } from './interface';
import A from './types1';
import { B, C, D } from './types2';
