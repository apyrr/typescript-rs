...
#[test]
pub fn test_signature_help_tagged_templates_with_overloaded_tags4() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates_with_overloaded_tags4(&mut t);
}

fn run_test_signature_help_tagged_templates_with_overloaded_tags4(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpTaggedTemplatesWithOverloadedTags4") {
        return;
    }
