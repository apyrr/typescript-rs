...
#[test]
pub fn test_code_fix_top_level_await_module_target_es2017_compiler_options_in_ts_config() {
    let mut t = TestingT;
    run_test_code_fix_top_level_await_module_target_es2017_compiler_options_in_ts_config(&mut t);
}
