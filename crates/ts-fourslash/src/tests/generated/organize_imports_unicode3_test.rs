...
#[test]
pub fn test_organize_imports_unicode3() {
    let mut t = TestingT;
    run_test_organize_imports_unicode3(&mut t);
}

fn run_test_organize_imports_unicode3(t: &mut TestingT) {
    if should_skip_if_failing("TestOrganizeImportsUnicode3") {
        return;
    }
