...
#[test]
pub fn test_jsx_tag_name_completion_unclosed() {
    let mut t = TestingT;
    run_test_jsx_tag_name_completion_unclosed(&mut t);
}

fn run_test_jsx_tag_name_completion_unclosed(t: &mut TestingT) {
    if should_skip_if_failing("TestJsxTagNameCompletionUnclosed") {
        return;
    }
