...
#[test]
pub fn test_code_fix_infer_from_function_this_usage_object_property_shorthand() {
    let mut t = TestingT;
    run_test_code_fix_infer_from_function_this_usage_object_property_shorthand(&mut t);
}
