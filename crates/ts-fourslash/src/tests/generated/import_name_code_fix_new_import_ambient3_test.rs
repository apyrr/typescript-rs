...
#[test]
pub fn test_import_name_code_fix_new_import_ambient3() {
    let mut t = TestingT;
    run_test_import_name_code_fix_new_import_ambient3(&mut t);
}
...
declare module "yet-another-ambient-module" {
   ...
   export var v3;
    ...
    f.verify_import_fix_at_position(
        t,
        &vec![
            r#"let a = "I am a non-trivial statement that appears before imports";
