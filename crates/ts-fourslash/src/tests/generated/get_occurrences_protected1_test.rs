...
#[test]
pub fn test_get_occurrences_protected1() {
    let mut t = TestingT;
    run_test_get_occurrences_protected1(&mut t);
}

fn run_test_get_occurrences_protected1(t: &mut TestingT) {
    if should_skip_if_failing("TestGetOccurrencesProtected1") {
        return;
    }
