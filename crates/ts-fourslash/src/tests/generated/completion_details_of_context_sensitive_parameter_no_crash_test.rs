...
#[test]
pub fn test_completion_details_of_context_sensitive_parameter_no_crash() {
    let mut t = TestingT;
    run_test_completion_details_of_context_sensitive_parameter_no_crash(&mut t);
}

fn run_test_completion_details_of_context_sensitive_parameter_no_crash(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionDetailsOfContextSensitiveParameterNoCrash") {
        return;
    }
