...
#[test]
pub fn test_auto_import_file_exclude_patterns7() {
    let mut t = TestingT;
    run_test_auto_import_file_exclude_patterns7(&mut t);
}

fn run_test_auto_import_file_exclude_patterns7(t: &mut TestingT) {
    if should_skip_if_failing("TestAutoImportFileExcludePatterns7") {
        return;
    }
