...
#[test]
pub fn test_go_to_source9_map_from_at_types2() {
    let mut t = TestingT;
    run_test_go_to_source9_map_from_at_types2(&mut t);
}

fn run_test_go_to_source9_map_from_at_types2(t: &mut TestingT) {
    if should_skip_if_failing("TestGoToSource9_mapFromAtTypes2") {
        return;
    }
...
_.[|/*propertyAccess*/add|]"#;
    ...
    f.verify_baseline_go_to_source_definition(
        ...
        &[
            ...
            "unresolvableNamedImport".to_string(),
