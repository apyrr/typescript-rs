...
#[test]
pub fn test_import_completions_package_json_imports_length2() {
    let mut t = TestingT;
    run_test_import_completions_package_json_imports_length2(&mut t);
}

fn run_test_import_completions_package_json_imports_length2(t: &mut TestingT) {
    skip_if_failing(t);
