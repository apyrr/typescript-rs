...
#[test]
pub fn test_quickinfo_verbosity_toplevel_truncation2() {
    let mut t = TestingT;
    run_test_quickinfo_verbosity_toplevel_truncation2(&mut t);
}

fn run_test_quickinfo_verbosity_toplevel_truncation2(t: &mut TestingT) {
    if should_skip_if_failing("TestQuickinfoVerbosityToplevelTruncation2") {
        return;
    }
