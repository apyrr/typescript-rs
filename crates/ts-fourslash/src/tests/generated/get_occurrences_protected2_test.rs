...
#[test]
pub fn test_get_occurrences_protected2() {
    let mut t = TestingT;
    run_test_get_occurrences_protected2(&mut t);
}

fn run_test_get_occurrences_protected2(t: &mut TestingT) {
    if should_skip_if_failing("TestGetOccurrencesProtected2") {
        return;
    }
