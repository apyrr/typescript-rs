...
#[test]
pub fn test_rename_for_default_export07() {
    let mut t = TestingT;
    run_test_rename_for_default_export07(&mut t);
}

fn run_test_rename_for_default_export07(t: &mut TestingT) {
    if should_skip_if_failing("TestRenameForDefaultExport07") {
        return;
    }
