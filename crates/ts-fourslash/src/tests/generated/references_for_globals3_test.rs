...
#[test]
pub fn test_references_for_globals3() {
    let mut t = TestingT;
    run_test_references_for_globals3(&mut t);
}

fn run_test_references_for_globals3(t: &mut TestingT) {
    if should_skip_if_failing("TestReferencesForGlobals3") {
        return;
    }
