...
#[test]
pub fn test_get_occurrences_declare2() {
    let mut t = TestingT;
    run_test_get_occurrences_declare2(&mut t);
}

fn run_test_get_occurrences_declare2(t: &mut TestingT) {
    if should_skip_if_failing("TestGetOccurrencesDeclare2") {
        return;
    }
