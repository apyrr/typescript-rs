...
#[test]
pub fn test_go_to_source8_map_from_at_types() {
    let mut t = TestingT;
    run_test_go_to_source8_map_from_at_types(&mut t);
}

fn run_test_go_to_source8_map_from_at_types(t: &mut TestingT) {
    if should_skip_if_failing("TestGoToSource8_mapFromAtTypes") {
        return;
    }
