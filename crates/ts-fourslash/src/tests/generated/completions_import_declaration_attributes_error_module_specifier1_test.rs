...
#[test]
pub fn test_completions_import_declaration_attributes_error_module_specifier1() {
    let mut t = TestingT;
    run_test_completions_import_declaration_attributes_error_module_specifier1(&mut t);
}
