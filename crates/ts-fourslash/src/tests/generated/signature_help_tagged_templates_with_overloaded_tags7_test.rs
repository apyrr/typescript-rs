...
#[test]
pub fn test_signature_help_tagged_templates_with_overloaded_tags7() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates_with_overloaded_tags7(&mut t);
}

fn run_test_signature_help_tagged_templates_with_overloaded_tags7(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpTaggedTemplatesWithOverloadedTags7") {
        return;
    }
...
f `${ }   ${/*1*/ fa/*2*/lse /*3*/}"#;
    ...
    parameter_name: Some("p2_o3".to_string()),
    parameter_span: Some("p2_o3: boolean".to_string()),
