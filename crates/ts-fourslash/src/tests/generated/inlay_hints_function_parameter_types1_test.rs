...
#[test]
pub fn test_inlay_hints_function_parameter_types1() {
    let mut t = TestingT;
    run_test_inlay_hints_function_parameter_types1(&mut t);
}

fn run_test_inlay_hints_function_parameter_types1(t: &mut TestingT) {
    if should_skip_if_failing("TestInlayHintsFunctionParameterTypes1") {
        return;
    }
