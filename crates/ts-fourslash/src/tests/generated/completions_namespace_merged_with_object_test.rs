...
#[test]
pub fn test_completions_namespace_merged_with_object() {
    let mut t = TestingT;
    run_test_completions_namespace_merged_with_object(&mut t);
}
...
N./*value*/;";
    ...
    f.verify_completions(
        ...
        Some(&CompletionsExpectedList {
            ...
            items: Some(CompletionsExpectedItems {
                includes: Vec::new(),
                excludes: Vec::new(),
                exact: vec![CompletionsExpectedItem::Label("T".to_string())],
                unsorted: Vec::new(),
            }),
    ...
    f.verify_completions(
        t,
        MarkerInput::Name("value".to_string()),
        Some(&CompletionsExpectedList {
            is_incomplete: false,
            item_defaults: Some(CompletionsExpectedItemDefaults {
                commit_characters: Some(default_commit_characters()),
