...
#[test]
pub fn test_code_fix_class_implement_interface_member_nested_type_alias() {
    let mut t = TestingT;
    run_test_code_fix_class_implement_interface_member_nested_type_alias(&mut t);
}
...
class C implements I {}";
    ...
    f.verify_code_fix(
        ...
        VerifyCodeFixOptions {
            ...
            new_file_content: r#"type Either<T> = { val: T } | Error;
interface I {
    x: Either<Either<string>>;
    foo(x: Either<Either<string>>): void;
}
