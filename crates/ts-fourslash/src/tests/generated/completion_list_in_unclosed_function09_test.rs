...
#[test]
pub fn test_completion_list_in_unclosed_function09() {
    let mut t = TestingT;
    run_test_completion_list_in_unclosed_function09(&mut t);
}

fn run_test_completion_list_in_unclosed_function09(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionListInUnclosedFunction09") {
        return;
    }
