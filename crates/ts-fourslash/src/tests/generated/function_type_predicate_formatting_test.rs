...
#[test]
pub fn test_function_type_predicate_formatting() {
    let mut t = TestingT;
    run_test_function_type_predicate_formatting(&mut t);
}
...
fn run_test_function_type_predicate_formatting(t: &mut TestingT) {
    ...
    f.go_to_marker(t, "");
    f.format_document(t, "");
    f.verify_current_line_content(t, "function bar(a: A): a is B { }");
    done();
}
