...
#[test]
pub fn test_auto_import_type_import2() {
    let mut t = TestingT;
    run_test_auto_import_type_import2(&mut t);
}

fn run_test_auto_import_type_import2(t: &mut TestingT) {
    if should_skip_if_failing("TestAutoImportTypeImport2") {
        return;
    }
...
console.log(A, D);"
    ...
    f.verify_import_fix_at_position(
        t,
        &vec![r"import { A, type C, D, type B } from './foo';
const b: B | C;
console.log(A, D);"
            .to_string()],
        Some(UserPreferences {
