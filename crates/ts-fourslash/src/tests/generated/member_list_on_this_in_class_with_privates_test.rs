...
#[test]
pub fn test_member_list_on_this_in_class_with_privates() {
    let mut t = TestingT;
    run_test_member_list_on_this_in_class_with_privates(&mut t);
}
            ...
            items: Some(CompletionsExpectedItems {
                ...
                exact: vec![
                    CompletionsExpectedItem::Item(lsproto::CompletionItem {
                        label: "privMeth".to_string(),
                        detail: Some("(method) C1.privMeth(): void".to_string()),
                        ..Default::default()
                    }),
                    CompletionsExpectedItem::Item(lsproto::CompletionItem {
                        label: "privProp".to_string(),
                        detail: Some("(property) C1.privProp: number".to_string()),
                        ..Default::default()
                    }),
                    CompletionsExpectedItem::Item(lsproto::CompletionItem {
