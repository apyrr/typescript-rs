...
#[test]
pub fn test_code_fix_infer_from_function_this_usage_object_property_shorthand_parameter() {
    let mut t = TestingT;
    run_test_code_fix_infer_from_function_this_usage_object_property_shorthand_parameter(&mut t);
}
