...
#[test]
pub fn test_completion_list_builder_locations_modules() {
    let mut t = TestingT;
    run_test_completion_list_builder_locations_modules(&mut t);
}
...
module A./*moduleName2*/";
    ...
    f.verify_completions(
        t,
        MarkerInput::Name("moduleName1".to_string()),
    ...
    f.verify_completions(
        t,
        MarkerInput::Name("moduleName2".to_string()),
        Some(&CompletionsExpectedList {
            is_incomplete: false,
            item_defaults: Some(CompletionsExpectedItemDefaults {
                commit_characters: Some(Vec::new()),
