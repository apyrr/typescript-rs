...
#[test]
pub fn test_completion_list_in_arrow_function_in_unclosed_call_site01() {
    let mut t = TestingT;
    run_test_completion_list_in_arrow_function_in_unclosed_call_site01(&mut t);
}
    ...
    f.verify_completions(
        ...
        Some(&CompletionsExpectedList {
            ...
            items: Some(CompletionsExpectedItems {
                includes: vec![
                    CompletionsExpectedItem::Label("fileName".to_string()),
                    CompletionsExpectedItem::Label("rootFileNames".to_string()),
                    CompletionsExpectedItem::Label("getAllFiles".to_string()),
