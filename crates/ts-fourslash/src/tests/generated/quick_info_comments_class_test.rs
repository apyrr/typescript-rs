...
#[test]
pub fn test_quick_info_comments_class() {
    let mut t = TestingT;
    run_test_quick_info_comments_class(&mut t);
}

fn run_test_quick_info_comments_class(t: &mut TestingT) {
    if should_skip_if_failing("TestQuickInfoCommentsClass") {
        return;
    }
