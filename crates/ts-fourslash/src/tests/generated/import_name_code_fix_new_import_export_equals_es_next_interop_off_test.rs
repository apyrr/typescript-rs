...
#[test]
pub fn test_import_name_code_fix_new_import_export_equals_es_next_interop_off() {
    let mut t = TestingT;
    run_test_import_name_code_fix_new_import_export_equals_es_next_interop_off(&mut t);
}
