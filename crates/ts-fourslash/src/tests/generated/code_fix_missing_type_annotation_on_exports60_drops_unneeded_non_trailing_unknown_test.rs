...
#[test]
pub fn test_code_fix_missing_type_annotation_on_exports60_drops_unneeded_non_trailing_unknown() {
    let mut t = TestingT;
    run_test_code_fix_missing_type_annotation_on_exports60_drops_unneeded_non_trailing_unknown(
        &mut t,
    );
}
...
";
    ...
    f.verify_code_fix(
        ...
        VerifyCodeFixOptions {
            description: "Add return type 'Foo'".to_string(),
            new_file_content: r"
export interface Foo<S = string, T = unknown> {}
