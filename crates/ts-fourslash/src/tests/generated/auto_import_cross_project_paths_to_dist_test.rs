...
#[test]
pub fn test_auto_import_cross_project_paths_to_dist() {
    let mut t = TestingT;
    run_test_auto_import_cross_project_paths_to_dist(&mut t);
}

fn run_test_auto_import_cross_project_paths_to_dist(t: &mut TestingT) {
    if should_skip_if_failing("TestAutoImportCrossProject_paths_toDist") {
        return;
    }
...
dep1;"#
    ...
    f.verify_import_fix_at_position(
        t,
        &vec![r#"import { dep2 } from "dep/dist/sub/folder";
