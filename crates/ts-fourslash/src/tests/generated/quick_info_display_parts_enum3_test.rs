...
#[test]
pub fn test_quick_info_display_parts_enum3() {
    let mut t = TestingT;
    run_test_quick_info_display_parts_enum3(&mut t);
}

fn run_test_quick_info_display_parts_enum3(t: &mut TestingT) {
    if should_skip_if_failing("TestQuickInfoDisplayPartsEnum3") {
        return;
    }
