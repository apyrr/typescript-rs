...
#[test]
pub fn test_completion_list_in_closed_function07() {
    let mut t = TestingT;
    run_test_completion_list_in_closed_function07(&mut t);
}

fn run_test_completion_list_in_closed_function07(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionListInClosedFunction07") {
        return;
    }
