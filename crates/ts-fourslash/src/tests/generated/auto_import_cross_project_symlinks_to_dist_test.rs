...
#[test]
pub fn test_auto_import_cross_project_symlinks_to_dist() {
    let mut t = TestingT;
    run_test_auto_import_cross_project_symlinks_to_dist(&mut t);
}

fn run_test_auto_import_cross_project_symlinks_to_dist(t: &mut TestingT) {
    if should_skip_if_failing("TestAutoImportCrossProject_symlinks_toDist") {
        return;
    }
...
// @link: /home/src/workspaces/project/packages/dep -> /home/src/workspaces/project/packages/app/node_modules/dep"#;
    ...
    f.verify_import_fix_at_position(
        t,
        &vec![r#"import { dep } from "dep/dist/sub/folder";
