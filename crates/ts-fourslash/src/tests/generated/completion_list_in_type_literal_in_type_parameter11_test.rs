...
#[test]
pub fn test_completion_list_in_type_literal_in_type_parameter11() {
    let mut t = TestingT;
    run_test_completion_list_in_type_literal_in_type_parameter11(&mut t);
}

fn run_test_completion_list_in_type_literal_in_type_parameter11(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionListInTypeLiteralInTypeParameter11") {
        return;
    }
