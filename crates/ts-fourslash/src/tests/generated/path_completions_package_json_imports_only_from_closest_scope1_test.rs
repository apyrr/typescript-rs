...
#[test]
pub fn test_path_completions_package_json_imports_only_from_closest_scope1() {
    let mut t = TestingT;
    run_test_path_completions_package_json_imports_only_from_closest_scope1(&mut t);
}
