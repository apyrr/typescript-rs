...
#[test]
pub fn test_completion_list_for_transitively_exported_members04() {
    let mut t = TestingT;
    run_test_completion_list_for_transitively_exported_members04(&mut t);
}
    ...
    f.verify_completions(
        ...
        Some(&CompletionsExpectedList {
            ...
            items: Some(CompletionsExpectedItems {
                includes: Vec::new(),
                excludes: Vec::new(),
                exact: vec![CompletionsExpectedItem::Label("I3".to_string())],
                unsorted: Vec::new(),
            }),
