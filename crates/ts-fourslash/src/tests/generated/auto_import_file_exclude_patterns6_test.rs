...
#[test]
pub fn test_auto_import_file_exclude_patterns6() {
    let mut t = TestingT;
    run_test_auto_import_file_exclude_patterns6(&mut t);
}

fn run_test_auto_import_file_exclude_patterns6(t: &mut TestingT) {
    if should_skip_if_failing("TestAutoImportFileExcludePatterns6") {
        return;
    }
...
export { Event };";
    ...
    f.verify_code_fix(
        ...
        VerifyCodeFixOptions {
            ...
            new_file_content: r"import { Event } from './canImport';
import { Parts } from './parts';
export class EditorParts implements Parts {
    options: Event;
}"
