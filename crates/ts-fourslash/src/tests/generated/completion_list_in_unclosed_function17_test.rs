...
#[test]
pub fn test_completion_list_in_unclosed_function17() {
    let mut t = TestingT;
    run_test_completion_list_in_unclosed_function17(&mut t);
}

fn run_test_completion_list_in_unclosed_function17(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionListInUnclosedFunction17") {
        return;
    }
