...
#[test]
pub fn test_rename_destructuring_assignment_nested_in_for2() {
    let mut t = TestingT;
    run_test_rename_destructuring_assignment_nested_in_for2(&mut t);
}

fn run_test_rename_destructuring_assignment_nested_in_for2(t: &mut TestingT) {
    if should_skip_if_failing("TestRenameDestructuringAssignmentNestedInFor2") {
        return;
    }
