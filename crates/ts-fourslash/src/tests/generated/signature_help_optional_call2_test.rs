...
#[test]
pub fn test_signature_help_optional_call2() {
    let mut t = TestingT;
    run_test_signature_help_optional_call2(&mut t);
}

fn run_test_signature_help_optional_call2(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpOptionalCall2") {
        return;
    }
