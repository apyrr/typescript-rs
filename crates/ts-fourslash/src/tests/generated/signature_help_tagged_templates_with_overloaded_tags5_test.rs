...
#[test]
pub fn test_signature_help_tagged_templates_with_overloaded_tags5() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates_with_overloaded_tags5(&mut t);
}

fn run_test_signature_help_tagged_templates_with_overloaded_tags5(t: &mut TestingT) {
    if should_skip_if_failing("TestSignatureHelpTaggedTemplatesWithOverloadedTags5") {
        return;
    }
