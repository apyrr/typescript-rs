...
#[test]
pub fn test_formatting_of_multiline_block_constructs() {
    let mut t = TestingT;
    run_test_formatting_of_multiline_block_constructs(&mut t);
}

fn run_test_formatting_of_multiline_block_constructs(t: &mut TestingT) {
    if should_skip_if_failing("TestFormattingOfMultilineBlockConstructs") {
        return;
    }
...
{};/*13*/";
    ...
    f.go_to_marker(t, "5");
    f.verify_current_line_content(t, "    public MyFunction() {");
    f.go_to_marker(t, "6");
