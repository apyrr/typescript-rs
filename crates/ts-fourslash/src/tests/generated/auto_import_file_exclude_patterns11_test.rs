...
#[test]
pub fn test_auto_import_file_exclude_patterns11() {
    let mut t = TestingT;
    run_test_auto_import_file_exclude_patterns11(&mut t);
}

fn run_test_auto_import_file_exclude_patterns11(t: &mut TestingT) {
    if should_skip_if_failing("TestAutoImportFileExcludePatterns11") {
        return;
    }
