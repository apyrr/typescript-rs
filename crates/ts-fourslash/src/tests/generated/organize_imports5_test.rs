...
#[test]
pub fn test_organize_imports5() {
    let mut t = TestingT;
    run_test_organize_imports5(&mut t);
}

fn run_test_organize_imports5(t: &mut TestingT) {
    if should_skip_if_failing("TestOrganizeImports5") {
        return;
    }
