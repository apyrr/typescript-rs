...
#[test]
pub fn test_get_outlining_for_block_comments() {
    let mut t = TestingT;
    run_test_get_outlining_for_block_comments(&mut t);
}

fn run_test_get_outlining_for_block_comments(t: &mut TestingT) {
    if should_skip_if_failing("TestGetOutliningForBlockComments") {
        return;
    }
    let content = r#"[|/*
