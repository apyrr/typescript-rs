...
#[test]
pub fn test_code_fix_missing_type_annotation_on_exports33_methods() {
    let mut t = TestingT;
    run_test_code_fix_missing_type_annotation_on_exports33_methods(&mut t);
}
  ...
  m() {
    ...
    f.verify_code_fix(
        ...
        VerifyCodeFixOptions {
            ...
            new_file_content: r"export class Foo {
  m(): void {
  }
}"
            .to_string(),
