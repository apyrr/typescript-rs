...
#[test]
pub fn test_signature_help_tagged_templates_with_overloaded_tags2() {
    let mut t = TestingT;
    run_test_signature_help_tagged_templates_with_overloaded_tags2(&mut t);
}
    ...
    for marker in f.marker_names() {
        ...
        f.verify_signature_help_options(
            ...
            VerifySignatureHelpOptions {
                ...
                parameter_name: Some("p1_o1".to_string()),
                parameter_span: Some("p1_o1: string".to_string()),
