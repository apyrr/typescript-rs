...
#[test]
pub fn test_import_type_member_completions() {
    let mut t = TestingT;
    run_test_import_type_member_completions(&mut t);
}
    ...
    f.verify_completions(
        ...
        Some(&CompletionsExpectedList {
            ...
            items: Some(CompletionsExpectedItems {
                includes: Vec::new(),
                excludes: Vec::new(),
                exact: vec![CompletionsExpectedItem::Label("Bar".to_string())],
                unsorted: Vec::new(),
            }),
            user_preferences: None,
        }),
    ...
    f.verify_completions(
        ...
        Some(&CompletionsExpectedList {
            ...
            items: Some(CompletionsExpectedItems {
                ...
                excludes: Vec::new(),
                exact: vec![
                    CompletionsExpectedItem::Label("Bat".to_string()),
                    CompletionsExpectedItem::Label("Baz".to_string()),
                ],
                unsorted: Vec::new(),
            }),
    ...
    f.verify_completions(
        ...
        Some(&CompletionsExpectedList {
            ...
            items: Some(CompletionsExpectedItems {
                includes: Vec::new(),
                excludes: Vec::new(),
                exact: vec![CompletionsExpectedItem::Label("Bat".to_string())],
                unsorted: Vec::new(),
            }),
            user_preferences: None,
        }),
