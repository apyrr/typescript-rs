...
#[test]
pub fn test_import_completions_imports_map5() {
    let mut t = TestingT;
    run_test_import_completions_imports_map5(&mut t);
}

fn run_test_import_completions_imports_map5(t: &mut TestingT) {
    if should_skip_if_failing("TestImportCompletions_importsMap5") {
        return;
    }
