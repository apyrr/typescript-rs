...
#[test]
pub fn test_completion_for_string_literal_nonrelative_import_typings1() {
    let mut t = TestingT;
    run_test_completion_for_string_literal_nonrelative_import_typings1(&mut t);
}

fn run_test_completion_for_string_literal_nonrelative_import_typings1(t: &mut TestingT) {
    if should_skip_if_failing("TestCompletionForStringLiteralNonrelativeImportTypings1") {
        return;
    }
