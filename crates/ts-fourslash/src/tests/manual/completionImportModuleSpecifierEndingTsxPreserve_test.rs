...
pub fn test_completion_import_module_specifier_ending_tsx_preserve(t: &mut TestingT) {
...
import { Test } from ".//**/""#;
    ...
    verify_completion(&mut f, t, "test.jsx", "test.jsx", "js");
    verify_completion(&mut f, t, "test", "test.tsx", "index");
    done();
}
...
fn verify_completion(
    ...
    let expected = CompletionsExpectedList {
        ...
        items: Some(CompletionsExpectedItems {
            includes: vec![completion_item(label, detail)],
            excludes: Vec::new(),
            exact: Vec::new(),
            unsorted: Vec::new(),
        }),
