...
impl NodeFactory {
    ...
    pub fn set_parsed_string_literal_text(&mut self, node: Node, value: String) {
        self.set_generated_string_literal_text(node, value);
    }

    pub fn set_parsed_no_substitution_template_literal_text(&mut self, node: Node, value: String) {
        self.set_generated_no_substitution_template_literal_text(node, value);
    }

    pub fn set_parsed_numeric_literal_text(&mut self, node: Node, value: String) {
        self.set_generated_numeric_literal_text(node, value);
    }
    ...
    pub fn force_cloned_string_literal_single_quote_from(
        ...
        self.set_generated_string_literal_token_flags(
            cloned,
    ...
    pub fn clear_synthetic_class_declaration_name(&mut self, node: Node) {
        self.set_generated_class_declaration_name(node, None::<Node>);
    }

    pub fn set_reparsed_type_alias_type_parameters(&mut self, node: Node, value: Option<NodeList>) {
        self.set_generated_type_alias_declaration_type_parameters(node, value);
    }
    ...
    pub fn set_reparsed_type_alias_type_node(
        ...
        self.set_generated_type_alias_declaration_type_node(node, value);
    }

    pub fn set_reparsed_import_clause_phase_modifier(&mut self, node: Node, value: Option<Kind>) {
        self.set_generated_import_clause_phase_modifier(node, value);
    }
    ...
    pub fn set_reparsed_shorthand_object_assignment_initializer(
        ...
        self.set_generated_shorthand_property_assignment_object_assignment_initializer(node, value);
    }
    ...
    pub fn set_reparsed_binary_expression_right(
        ...
        self.set_generated_binary_expression_right(node, value);
    }
    ...
    pub fn set_reparsed_parameter_question_token(
        ...
        self.set_generated_parameter_declaration_question_token(node, value);
    }

    pub fn set_reparsed_heritage_clause_types(&mut self, node: Node, value: NodeList) {
        self.set_generated_heritage_clause_types(node, value);
    }
    ...
    pub fn set_reparsed_expression_with_type_arguments_type_arguments(
        ...
        self.set_generated_expression_with_type_arguments_type_arguments(node, value);
    }

    pub fn set_reparsed_class_type_parameters(&mut self, node: Node, value: Option<NodeList>) {
        match self.kind(node) {
            Kind::ClassDeclaration => {
                self.set_generated_class_declaration_type_parameters(node, value)
            }
            Kind::ClassExpression => {
                self.set_generated_class_expression_type_parameters(node, value)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_class_heritage_clauses(&mut self, node: Node, value: Option<NodeList>) {
        match self.kind(node) {
            Kind::ClassDeclaration => {
                self.set_generated_class_declaration_heritage_clauses(node, value)
            }
            Kind::ClassExpression => {
                self.set_generated_class_expression_heritage_clauses(node, value)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_type_node(&mut self, node: Node, type_node: Option<Node>) {
        match self.kind(node) {
            Kind::VariableDeclaration => {
                self.set_generated_variable_declaration_type_node(node, type_node)
            }
            Kind::Parameter => self.set_generated_parameter_declaration_type_node(node, type_node),
            Kind::PropertySignature => {
                self.set_generated_property_signature_declaration_type_node(node, type_node)
            }
            Kind::PropertyDeclaration => {
                self.set_generated_property_declaration_type_node(node, type_node)
            }
            Kind::PropertyAssignment => {
                self.set_generated_property_assignment_type_node(node, type_node)
            }
            Kind::ShorthandPropertyAssignment => {
                self.set_generated_shorthand_property_assignment_type_node(node, type_node)
            }
            Kind::ExportAssignment => {
                self.set_generated_export_assignment_type_node(node, type_node)
            }
            Kind::BinaryExpression => {
                self.set_generated_binary_expression_type_node(node, type_node)
            }
            Kind::TypeAliasDeclaration | Kind::JSTypeAliasDeclaration => {
                self.set_generated_type_alias_declaration_type_node(node, type_node)
            }
            Kind::GetAccessor => {
                self.set_generated_get_accessor_declaration_type_node(node, type_node)
            }
            Kind::SetAccessor => {
                self.set_generated_set_accessor_declaration_type_node(node, type_node)
            }
            Kind::MethodDeclaration => {
                self.set_generated_method_declaration_type_node(node, type_node)
            }
            Kind::FunctionDeclaration => {
                self.set_generated_function_declaration_type_node(node, type_node)
            }
            Kind::FunctionExpression => {
                self.set_generated_function_expression_type_node(node, type_node)
            }
            Kind::ArrowFunction => self.set_generated_arrow_function_type_node(node, type_node),
            Kind::Constructor => {
                self.set_generated_constructor_declaration_type_node(node, type_node)
            }
            Kind::FunctionType => self.set_generated_function_type_node_type_node(node, type_node),
            Kind::ConstructorType => {
                self.set_generated_constructor_type_node_type_node(node, type_node)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_expression_node(&mut self, node: Node, expression: Option<Node>) {
        match self.kind(node) {
            Kind::ReturnStatement => {
                self.set_generated_return_statement_expression(node, expression)
            }
            Kind::ParenthesizedExpression => {
                self.set_generated_parenthesized_expression_expression(node, expression)
            }
            Kind::ExportAssignment => {
                self.set_generated_export_assignment_expression(node, expression)
            }
            Kind::ExpressionWithTypeArguments => {
                self.set_generated_expression_with_type_arguments_expression(node, expression)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_initializer(&mut self, node: Node, initializer: Option<Node>) {
        match self.kind(node) {
            Kind::VariableDeclaration => {
                self.set_generated_variable_declaration_initializer(node, initializer)
            }
            Kind::Parameter => {
                self.set_generated_parameter_declaration_initializer(node, initializer)
            }
            Kind::PropertyDeclaration => {
                self.set_generated_property_declaration_initializer(node, initializer)
            }
            Kind::PropertyAssignment => {
                self.set_generated_property_assignment_initializer(node, initializer)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_modifiers(&mut self, node: Node, modifiers: Option<ModifierList>) {
        match self.kind(node) {
            Kind::PropertyDeclaration => {
                self.set_generated_property_declaration_modifiers(node, modifiers)
            }
            Kind::MethodDeclaration => {
                self.set_generated_method_declaration_modifiers(node, modifiers)
            }
            Kind::GetAccessor => {
                self.set_generated_get_accessor_declaration_modifiers(node, modifiers)
            }
            Kind::SetAccessor => {
                self.set_generated_set_accessor_declaration_modifiers(node, modifiers)
            }
            Kind::BinaryExpression => {
                self.set_generated_binary_expression_modifiers(node, modifiers)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_function_like_type_parameters(
        ...
        match self.kind(node) {
            Kind::FunctionDeclaration => {
                self.set_generated_function_declaration_type_parameters(node, type_parameters)
            }
            Kind::Constructor => {
                self.set_generated_constructor_declaration_type_parameters(node, type_parameters)
            }
            Kind::GetAccessor => {
                self.set_generated_get_accessor_declaration_type_parameters(node, type_parameters)
            }
            Kind::SetAccessor => {
                self.set_generated_set_accessor_declaration_type_parameters(node, type_parameters)
            }
            Kind::MethodDeclaration => {
                self.set_generated_method_declaration_type_parameters(node, type_parameters)
            }
            Kind::ArrowFunction => {
                self.set_generated_arrow_function_type_parameters(node, type_parameters)
            }
            Kind::FunctionExpression => {
                self.set_generated_function_expression_type_parameters(node, type_parameters)
            }
            Kind::CallSignature => {
                self.set_generated_call_signature_declaration_type_parameters(node, type_parameters)
            }
            ...
            Kind::FunctionType => {
                self.set_generated_function_type_node_type_parameters(node, type_parameters)
            }
            Kind::ConstructorType => {
                self.set_generated_constructor_type_node_type_parameters(node, type_parameters)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_function_like_parameters(&mut self, node: Node, parameters: NodeList) {
        match self.kind(node) {
            Kind::FunctionDeclaration => {
                self.set_generated_function_declaration_parameters(node, parameters)
            }
            Kind::Constructor => {
                self.set_generated_constructor_declaration_parameters(node, parameters)
            }
            Kind::GetAccessor => {
                self.set_generated_get_accessor_declaration_parameters(node, parameters)
            }
            Kind::SetAccessor => {
                self.set_generated_set_accessor_declaration_parameters(node, parameters)
            }
            Kind::MethodDeclaration => {
                self.set_generated_method_declaration_parameters(node, parameters)
            }
            Kind::ArrowFunction => self.set_generated_arrow_function_parameters(node, parameters),
            Kind::FunctionExpression => {
                self.set_generated_function_expression_parameters(node, parameters)
            }
            Kind::CallSignature => {
                self.set_generated_call_signature_declaration_parameters(node, parameters)
            }
            Kind::ConstructSignature => {
                self.set_generated_construct_signature_declaration_parameters(node, parameters)
            }
            Kind::IndexSignature => {
                self.set_generated_index_signature_declaration_parameters(node, parameters)
            }
            Kind::MethodSignature => {
                self.set_generated_method_signature_declaration_parameters(node, parameters)
            }
            Kind::FunctionType => {
                self.set_generated_function_type_node_parameters(node, parameters)
            }
            Kind::ConstructorType => {
                self.set_generated_constructor_type_node_parameters(node, parameters)
            }
            _ => panic!(
    ...
    pub fn set_reparsed_function_like_full_signature(
        ...
        match self.kind(node) {
            Kind::FunctionDeclaration => {
                self.set_generated_function_declaration_full_signature(node, full_signature)
            }
            Kind::Constructor => {
                self.set_generated_constructor_declaration_full_signature(node, full_signature)
            }
            Kind::GetAccessor => {
                self.set_generated_get_accessor_declaration_full_signature(node, full_signature)
            }
            Kind::SetAccessor => {
                self.set_generated_set_accessor_declaration_full_signature(node, full_signature)
            }
            Kind::MethodDeclaration => {
                self.set_generated_method_declaration_full_signature(node, full_signature)
            }
            Kind::ArrowFunction => {
                self.set_generated_arrow_function_full_signature(node, full_signature)
            }
            Kind::FunctionExpression => {
                self.set_generated_function_expression_full_signature(node, full_signature)
            }
            Kind::CallSignature => {
                self.set_generated_call_signature_declaration_full_signature(node, full_signature)
            }
            Kind::ConstructSignature => self
                .set_generated_construct_signature_declaration_full_signature(node, full_signature),
            Kind::IndexSignature => {
                self.set_generated_index_signature_declaration_full_signature(node, full_signature)
            }
            Kind::MethodSignature => {
                self.set_generated_method_signature_declaration_full_signature(node, full_signature)
            }
            Kind::FunctionType => {
                self.set_generated_function_type_node_full_signature(node, full_signature)
            }
            Kind::ConstructorType => {
                self.set_generated_constructor_type_node_full_signature(node, full_signature)
            }
            _ => panic!(
